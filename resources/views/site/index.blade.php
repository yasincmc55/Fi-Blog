...
<div class="container">
        <section>
            <div class="feature-posts">
                ...
                <a href="single-post.html" class="feature-post-item">
                    <img src=" {{ asset ('assets/site/imgs/img-1.jpg' )}} " class="w-100" alt="">
                    <div class="feature-post-caption">Incidunt Quaerat</div>
                </a>
                <a href="single-post.html" class="feature-post-item">
                    <img src=" {{ asset ('assets/site/imgs/img-2.jpg' )}} " class="w-100" alt="">
                    <div class="feature-post-caption">Culpa Ducimus</div>
                </a>
                <a href="single-post.html" class="feature-post-item">
                    <img src=" {{ asset ('assets/site/imgs/img-3.jpg' )}} " class="w-100" alt="">
                    <div class="feature-post-caption">Temporibus Simile</div>
                </a>
                <a href="single-post.html" class="feature-post-item">
                    <img src=" {{ asset ('assets/site/imgs/img-4.jpg' ) }}" class="w-100" alt="">
        ...
        <div class="page-container">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="blog-media">
                            <img src=" {{ asset ('assets/site/imgs/blog-6.jpg' )}} " alt="" class="w-100">
                ...
                <div class="row">                       
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src=" {{ asset ('assets/site/imgs/blog-2.jpg' )   }} " alt="" class="w-100">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src=" {{ asset ('assets/site/imgs/blog-3.jpg' )}} " alt="" class="w-100">
                ...
                <div class="row">                       
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src=" {{ asset ('assets/site/imgs/blog-4.jpg' )}}" alt="" class="w-100">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src=" {{ asset ('assets/site/imgs/blog-5.jpg' )}}" alt="" class="w-100">
                ...
                <div class="row">                       
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src=" {{ asset ('assets/site/imgs/blog-1.jpg' )}}" alt="" class="w-100">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center mb-5">
                            <div class="card-header p-0">                                   
                                <div class="blog-media">
                                    <img src=" {{ asset ('assets/site/imgs/blog-7.jpg' )}}" alt="" class="w-100">
            ...
            <div class="page-sidebar text-center">
                ...
                <img src=" {{ asset ('assets/site/imgs/avatar.jpg')}} " alt="" class="circle-100 mb-3">
                ...
                <div class="row px-3">
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src=" {{ asset ('assets/site/imgs/insta-1.jpg' )   }} " alt="">
                        </a>
                    </div>
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src=" {{ asset ('assets/site/imgs/insta-2.jpg' )   }} " alt="" class="w-100 m-0">
                        </a>
                    </div>  
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src=" {{ asset ('assets/site/imgs/insta-3.jpg' )   }} " alt="" class="w-100">
                        </a>
                    </div>
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src=" {{ asset ('assets/site/imgs/insta-4.jpg' )   }} " alt="" class="w-100 m-0">
                        </a>
                    </div>  
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src=" {{ asset ('assets/site/imgs/insta-5.jpg' )   }} " alt="" class="w-100">
                        </a>
                    </div>
                    <div class="col-4 p-1 figure">
                        <a href="#" class="figure-img">
                            <img src=" {{ asset ('assets/site/imgs/insta-6.jpg' )   }} " alt="" class="w-100 m-0">
                        </a>
                    </div>                          
                </div>  
                ...
                <figure class="figure mt-5">
                    <a href="single-post.html" class="figure-img">
                        <img src=" {{ asset ('assets/site/imgs/img-4.jpg' )   }} " alt="" class="w-100">
                ...
                <div class="media text-left mb-4">
                    <a href="single-post.html" class="overlay-link"></a>
                    <img class="mr-3" src=" {{ asset ('assets/site/imgs/blog-1.jpg' )   }} " width="100px" alt="Generic placeholder image">
                ...
                <div class="media text-left mb-4">
                    <a href="single-post.html" class="overlay-link"></a>
                    <img class="mr-3" src=" {{ asset ('assets/site/imgs/blog-2.jpg' )   }}" width="100px" alt="Generic placeholder image">
                    <div class="media-body">
                ...
                <div class="media text-left mb-4">
                    <a href="single-post.html" class="overlay-link"></a>
                    <img class="mr-3" src=" {{ asset ('assets/site/imgs/blog-3.jpg' )   }} " width="100px" alt="Generic placeholder image">
                    <div class="media-body">
